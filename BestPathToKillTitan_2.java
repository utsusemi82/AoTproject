 ...
 * @author Isaiah
 */
public class BestPathToKillTitan_2.4 implements Initializable {
...
/**
                ...
                alert.setHeaderText("Enter the Titan location");
                ...
                Alert alert = new Alert(Alert.AlertType.WARNING);
                alert.setHeaderText("You entered a non-existent location");
                if(alert.showAndWait().get() == ButtonType.OK){
                    mapNodeText.clear();
                    pathTextArea.clear();
                }
    ...
    **/
	...
	// Loop for all the parents or previous vertices of the given vertex-->>
